...
This agenda can be viewed and updated on [Github](https://github.com/immersive-web/administrivia/blob/master/meetings/wg/2020-02-11-Immersive_Web_Working_Group_Teleconference-agenda.md).

If you would like to add an item to the agenda or volunteer to scribe please open a pull request against this agenda.

* [webxr#956 Visibility state behavior is not clearly specified for inline sessions](https://github.com/immersive-web/webxr/issues/956) - cabanier
> From reading the spec, it is unclear what events should trigger on inline session.
 >For head mounted devices, should inline session become hidden when going immersive?

* [webxr#958 Controller and ray position are UA dependent](https://github.com/immersive-web/webxr/issues/958) - cabanier
> Someone reported an issue on [twitter](https://twitter.com/fernandojsg/status/1225871240243679232) where the pointing ray was intersecting the model that was posted on the [WebXR profiles repo](https://github.com/immersive-web/webxr-input-profiles).
 >

### Immersive Web Working Group Teleconference - 2020-02-11

<table>
<tr><td> San Francisco (U.S.A. - California) <td> Tuesday, February 11, 12:00 PM PST
<tr><td> Boston (U.S.A. - Massachusetts) <td> Tuesday, February 11, 3:00 PM EST
<tr><td> London (United Kingdom - England) <td> Tuesday, February 11, 8:00 PM GMT
<tr><td> Paris (France) <td> Tuesday, February 11, 9:00 PM GMT+1
<tr><td> Tokyo (Japan) <td> Wednesday, February 12, 5:00 AM GMT+9
<tr><td> Corresponding UTC (GMT) <td> Tuesday, February 11, 8:00 PM UTC
</table>
